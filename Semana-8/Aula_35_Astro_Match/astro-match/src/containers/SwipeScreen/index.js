...
import { getNewProfile, requestChosenProfile } from '../../actions/profiles'
...
const mapDispatchToProps = (dispatch) => {
	return {
		...
		chooseProfile: (profileToSwipe) => dispatch(requestChosenProfile(profileToSwipe)),
	}
}
